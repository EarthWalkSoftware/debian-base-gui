...
When using the X11 server over a WAN (e.g., Internet), additional steps to isolate the docker container from the docker host must be taken. Alternatively, a more robust and secure solution, such as *x11docker* and *x11docker-gui*, is worthy of investigation:
